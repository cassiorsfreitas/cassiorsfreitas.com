...
summary: 'Spotify Web API endpoints return JSON about music artists, albums, and tracks, directly from the Spotify Data Catalogue.'
image: '/images/nextjs-spotify/cover.jpg'
---
...
<Image
  ...
  src={`/images/nextjs-spotify/cover.jpg`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  alt={`An iceberg of react frameworks, showing that while most of the time it seems it's just components and business logic, the reality is that under water there are many other things frameworks are handling for you, like authentication, rendering, routing, state management, i18n, styling, and more.`}
  src={`/images/nextjs-spotify/example1.png`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  alt={`An iceberg of react frameworks, showing that while most of the time it seems it's just components and business logic, the reality is that under water there are many other things frameworks are handling for you, like authentication, rendering, routing, state management, i18n, styling, and more.`}
  src={`/images/nextjs-spotify/example2.png`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  alt={`An iceberg of react frameworks, showing that while most of the time it seems it's just components and business logic, the reality is that under water there are many other things frameworks are handling for you, like authentication, rendering, routing, state management, i18n, styling, and more.`}
  src={`/images/nextjs-spotify/example3.png`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
**Important:** This token is [valid indefinitely](https://github.com/spotify/web-api/issues/374) unless you revoke access, so we'll want to save this in an environment variable.
