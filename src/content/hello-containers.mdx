...
summary: 'Like the real world example of a container, the contents is isolated. Let me show you though.'
image: '/images/hello-containers/cover.jpg'
---

<Image
  alt={`Hello, Containers Cover Image`}
  src={`/images/hello-containers/cover.jpg`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  alt={`Hello, Containers Cover Image`}
  src={`/images/hello-containers/container.png`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  alt={`Hello, Containers Cover Image`}
  src={`/images/hello-containers/virtual.png`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
There are many points that determine the choice of a VM or Container. My goal is just to help you think about them. To explain each point, let's consider the most popular cloud services on the market: AWS, Azure, and Google Cloud Platform.
...
- **docker –version**
  ...
  <Image
  alt={`Hello, Containers Cover Image`}
  src={`/images/hello-containers/code1.png`}
  width={2478 / 3}
  height={2784 / 3}
  />
...
- **docker pull**
  ...
  <Image
  alt={`Hello, Containers Cover Image`}
  src={`/images/hello-containers/code2.png`}
  width={2478 / 3}
  height={2784 / 3}
  />
...
- **docker run**
  ...
  <Image
  alt={`Hello, Containers Cover Image`}
  src={`/images/hello-containers/code3.png`}
  width={2478 / 3}
  height={2784 / 3}
  />
...
- **docker ps**
  ...
  <Image
  alt={`Hello, Containers Cover Image`}
  src={`/images/hello-containers/code4.png`}
  width={2478 / 3}
  height={2784 / 3}
  />
...
- **docker ps -a**
  ...
  <Image
  alt={`Hello, Containers Cover Image`}
  src={`/images/hello-containers/code5.png`}
  width={2478 / 3}
  height={2784 / 3}
  />
...
- **docker exec**
  ...
  <Image
  alt={`Hello, Containers Cover Image`}
  src={`/images/hello-containers/code6.png`}
  width={2478 / 3}
  height={2784 / 3}
  />
...
- **docker stop**
  ...
  <Image
  alt={`Hello, Containers Cover Image`}
  src={`/images/hello-containers/code7.png`}
  width={2478 / 3}
  height={2784 / 3}
  />
...
- **docker images**
  ...
  <Image
  alt={`Hello, Containers Cover Image`}
  src={`/images/hello-containers/code8.png`}
  width={2478 / 3}
  height={2784 / 3}
  />
