...
summary: 'Let me introduce you to Serverless or Serverless computing and how it may be helpful.'
image: '/images/hello-serverless/cover.jpg'
---

<Image
  alt={`Hello, Serverless.`}
  src={`/images/hello-serverless/cover.jpg`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  ...
  src={`/images/hello-serverless/example-boom.webp`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  alt={`An iceberg of react frameworks, showing that while most of the time it seems it's just components and business logic, the reality is that under water there are many other things frameworks are handling for you, like authentication, rendering, routing, state management, i18n, styling, and more.`}
  src={`/images/hello-serverless/example-nextjs.png`}
  width={2478 / 3}
  height={2784 / 3}
/>

Thanks to this kind of approach, we can develop a front end application that navigates through [different architectures](https://cassiorsfreitas.com/blog/ssg-spa-and-ssr-pick-one).  Some pages are SPA and will request resources at runtime, others are SSR and will process all server side resources, and others are SSG and process best side at build time. **The modern backend is a Javascript function**.

<Image
  alt={`An iceberg of react frameworks, showing that while most of the time it seems it's just components and business logic, the reality is that under water there are many other things frameworks are handling for you, like authentication, rendering, routing, state management, i18n, styling, and more.`}
  src={`/images/hello-serverless/example-nextjs2.png`}
  width={2478 / 3}
  height={2784 / 3}
/>
