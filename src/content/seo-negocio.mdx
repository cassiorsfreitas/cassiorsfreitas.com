...
summary: 'Aparecer ou não no Google pode definir o futuro do seu projeto. Mas, antes de tudo, você sabe mesmo o que é SEO?'
image: '/images/seo-negocio/image-seo.jpg'
---

<Image
  alt={`SEO: peça chave para o seu negócio`}
  src={`/images/seo-negocio/image-seo.jpg`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  alt={`SEO: peça chave para o seu negócio`}
  src={`/images/seo-negocio/google-example.jpeg`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  alt={`SEO: peça chave para o seu negócio`}
  src={`/images/seo-negocio/rd-example1.jpeg`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  alt={`SEO: peça chave para o seu negócio`}
  src={`/images/seo-negocio/rd-example2.jpeg`}
  width={2478 / 3}
  height={2784 / 3}
/>
