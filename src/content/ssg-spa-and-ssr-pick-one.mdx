...
summary: 'In the last decade, front end development went through multiple paradigm changes that make it hard to follow.'
image: '/images/ssg-spa-ssr-pick-one/structure.jpg'
---

<Image
  alt={`SSG, SPA and SSR. Pick one!`}
  src={`/images/ssg-spa-ssr-pick-one/structure.jpg`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  alt={`SSG, SPA and SSR. Pick one!`}
  src={`/images/ssg-spa-ssr-pick-one/pickarenderpreview.png`}
  width={2478 / 3}
  height={2784 / 3}
/>
