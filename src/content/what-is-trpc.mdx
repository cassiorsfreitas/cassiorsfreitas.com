...
summary: 'Wait, so are we going back to use mono repository which contain the whole application? Like Java + Tomcat + Thymeleaf???'
image: '/images/what-is-trpc/cover.jpeg'
---

<Image
  alt={`What is tRPC?`}
  src={`/images/what-is-trpc/cover.jpeg`}
  width={2478 / 3}
  height={2784 / 3}
/>

First of all, I need to assume that you know what an API is or at least read the Wikipedia definition and then this article doesn't need to be long. Just for our context, Application Programming Interface is a bunch of rules that allow the client sends and receives messages from the server through the internet. If curiosity pushes you to learn about communication over the web, [check this article later](https://cassiorsfreitas.com/blog/communication-over-the-web).
...
<Image
  alt={`What is tRPC?`}
  src={`/images/what-is-trpc/idl.png`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  alt={`What is tRPC?`}
  src={`/images/what-is-trpc/trpc.gif`}
  width={2478 / 3}
  height={2784 / 3}
/>
...
<Image
  alt={`What is tRPC?`}
  src={`/images/what-is-trpc/fantastic.gif`}
  width={2478 / 3}
  height={2784 / 3}
/>
